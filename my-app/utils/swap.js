...
/*
    getAmountOfTokenRecievedFromSwap: Returns the number of Eth/Crypto Dev tokens that can be recieved 
    when the user swaps `_swapAmountWei` amount of Eth/Crypto Dev tokens.
*/
export const getAmountOfTokenRecievedFromSwap = async (
    _swapAmountWei,
    provider,
    ethSelected,
    ethBalance,
...
export const swapTokens = async (
    ...
    if (ethSelected) {
        ...
        // send back `tokenToBeRecievedAfterSwap` amount of `Eth` to the user
