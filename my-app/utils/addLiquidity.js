...
export const addLiquidity = async (
    ...
    try {
        ...
        // Because CD tokens are on ERC20, user would need to give the contract allowance 
...
export const calculateCD = async (
    ...
    // `_addEther` is a string, we need to convert it to Bignumber before we can do our calculations 
    ...
    // So by maths we get (amount of Crypto Dev tokens to be added) = (Eth that would be added * Crypto Dev tokens) / (Eth reserve in the contract)
