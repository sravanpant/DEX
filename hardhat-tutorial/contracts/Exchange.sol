...
contract Exchange is ERC20 {
    ...
    // Exchange is inheriting ERC20, because our exchange would keep of track of CryptoDev LP tokens 
    ...
    function removeLiquidity(uint _amount) public returns (uint, uint) {
        ...
        // = (amount of LP tokens that user wants withdraw) / (total supply of LP tokens)
